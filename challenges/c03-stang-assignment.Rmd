...
-   How many aluminum alloys are in this dataset? How do you know?
    -   There is one type of aluminium alloy in this dataset, because under the "alloy" column all the samples have the same value of "al_24st".
...
-   The statement that "nu is usually the greatest at 45 degrees" remains generally true especially when we compare the dots of the same thickness (distinguished by color). The dots at 45 degrees are mainly located at the top of the graph, representing the greatest values of nu.
...
- The following graph contradicts with the claim that "elasticity E is an intensive material property," because the elasticity of the material increases as the amount of it increases.\
- This evidence is not conclusive. Although the existing data shows that the conclusion the elasticity of the material increases as the amount of it increases" is correct, we need more data points taken from a wider range to make the statement conclusive, i.e. we need a wider range of thickness as well as smaller intervals between every two adjacent thickness values. For each thickness, ideally we should have more data points (e.g. at least 10).
...
-   Does this graph support or contradict the claim above?
    -   The graph contradicts with the claim that "elasticity E is an intensive material property", because the purple dots which stand for the thickest aluminium tend to have the smallest E values while the red dots that stand for the thinnest aluminium tend to have the highest elasticity.
