...
-   It shows the scales of MICs of each of the three types of
    antibiotics.
...
-   Because Diplococcus pneumoniae has similar reactions comparing to
    Streptococcus hemolyticus and Streptococcus viridans to all the
    three antibiotics.
...
-   It shows the difference of the effectiveness of the antibiotics in
    color, and the bars representing Diplococcus pneumoniae,
    Streptococcus hemolyticus and Streptococcus viridans stand out among
    the bars of all the other bacteria types.
