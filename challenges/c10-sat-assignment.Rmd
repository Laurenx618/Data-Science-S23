...
-   To what extent does `both_SAT` look like a normal distribution?
    -   It has a overall shape that looks similar to a normal
        distribution, except that the count is pretty low when both_SAT
        is at roughly 1150, 1300 and 1400.
-   To what extent does `high_GPA` look like a normal distribution?
    -   It has a overall shape that looks similar to a normal
        distribution, except that the count is pretty low when high_GPA
        is at roughly 3.0.
...
-   Between `both_SAT` and `high_GPA`, which single variable would you
    ...
    -   High school GPA, because it has a significantly higher
        correlation to the university GPA.
