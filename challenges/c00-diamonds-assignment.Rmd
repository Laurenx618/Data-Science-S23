...
-   Price generally increases as carat increases, but it is difficult to tell if the relationship is linear or not.
...
-   In addition to the previous visualization, people describe the cut to be the most ideal when a certain amount of diamond in carat can be sold at a price that is as high as possible, and vise versa.
