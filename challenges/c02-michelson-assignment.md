...
- <a href="#grading-rubric" id="toc-grading-rubric">Grading Rubric</a>
  ...
  - <a href="#due-date" id="toc-due-date">Due Date</a>
    ...
    - <a
      ...
      Create a new variable <code>VelocityVacuum</code> with the <img
      style="vertical-align:middle"
      src="https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&amp;space;%5Cbg_white&amp;space;%5Ctextstyle%20%2B92"
      alt="+92" title="+92" class="math inline" /> km/s adjustment to
...
![v_0 = 299944 \pm 51](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;v_0%20%3D%20299944%20%5Cpm%2051 "v_0 = 299944 \pm 51")
kilometers per second (in a vacuum). This is very close to the modern
*exact* value of 2.9979246^{5}. In this challenge, you will analyze
Michelson’s original data, and explore some of the factors associated
with his experiment.
...
light in a vacuum. In total, he added
![+92](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%2B92 "+92")
km/s to his mean estimate for `VelocityVacuum` (from Michelson (1880),
pg. 141). While the following isn’t fully rigorous
(![+92](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%2B92 "+92")
km/s is based on the mean temperature), we’ll simply apply this
correction to all the observations in the dataset.

### **q2** Create a new variable `VelocityVacuum` with the ![+92](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%2B92 "+92") km/s adjustment to `Velocity`. Assign this new dataframe to `df_q2`.
...
- Michelson’s estimate of the error (51) is smaller than the true error
  (151.542).
...
- The first couple of days of the real data has more data points whose
  ...
  real data has more data points that lies beyond the range compared to
  the Michelson’s simulated data.
...
- There is no distinct pattern of the data points in the first subplot,
  and therefore the temperature is not necessarily relevant to the
  errors in Michelson’s velocity measurements.
- Although the mean error in Michelson’s velocity measurements tends to
  be slightly lower when distinctness is poor, the pattern is not
