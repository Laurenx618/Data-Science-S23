...
-   Document your observations here.
    -   The median household income difference among different categories (2 to 6 -person families) is the smallest in Suffolk.
    -   Nantucket and Dukes have the greatest confidence intervals of median household income values among all the counties.
    -   Median household income generally increases as the number of people in the families increases, but there are some exceptions especially regarding 6-person families.
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No, we cannot. The median household income among different categories are quite similar compared to other counties, and the confidence intervals overlap to a great extent.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   The income standard error decreases on a log base 10 scale along with the increase of population.
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   It's easier to study the smaller counties because they tend to have a smaller standard error.
...
-   The income estimation in Maine generally has an increasing trend along with a growing population per county, except that there are two distinct spikes across all the household categories that appeared when population is roughly 31k and 35k.
