...
-   Was your sample size $n$ large enough? Why do you say that?
    -   My sample size (500,000) is large enough to produce a value which can be applied in most disciplines, because the entire confidence interval lies from roughly 3.1372 to 3.1462 with a accuracy to 2 significant figures.
