...
-   Is the bolded response **active** or **passive**? Why?
    -   It's active because it's closely responding to the college's question, and provides a valid answer.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   It's constructive because it agrees that what the colleague said was true.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   This makes me feel happy and confident of what I've just found, if I were the colleague.
...
-   Is the bolded response **active** or **passive**? Why?
    -   It's passive because it didn't really answer the question that the colleague brought up.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   It's constructive because it still agrees that what the colleague said was valid.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   I'm feeling ignored and I'm wondering what is wrong with this presenter.
...
-   Is the bolded response **active** or **passive**? Why?
    -   It's passive because the question is not related to the content of the presenter's speech.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   It's destructive because it didn't give any positive comments on the presenter's work, and the way of asking is a bit too straightforward and rude.
