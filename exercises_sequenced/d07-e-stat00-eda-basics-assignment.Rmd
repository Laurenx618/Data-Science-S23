...
Yes, Idea is the "best" value of cut for a diamond. However,
...
-   From the box plot, it seems that the Ideal diamonds are the least
    pricey (according the values of its median, upper- and
...
-   Yes, that would make sense. The median value of Ideal cuts is lower
    than that of all other cuts, which proves the point that the
    producers increase the carats to compromise for the cuts.
